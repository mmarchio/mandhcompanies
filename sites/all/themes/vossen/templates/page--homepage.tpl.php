...
<?php if (theme_get_setting('preloader')): ?>
	<div id="preloader"><div class="loader">  
		<img src="<?php print (drupal_get_path('theme', 'vossen')); ?>/images/assets/preloader-logo.jpg" alt="<?php print $site_name; ?>"> 
		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand home-link" rel="home" href="<?php print $front_page; ?>">
					<img src="<?php print $base_path . $path_to_theme; ?>/images/assets/logo-white.jpg" alt="<?php print $site_name; ?>" class="logo-big">
					<img src="<?php print $base_path . $path_to_theme; ?>/images/assets/logo-dark.jpg" alt="<?php print $site_name; ?>" class="logo-small">
				</a>
			</div>
